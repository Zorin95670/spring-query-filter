...
- Added `SpringQueryExecutor`: a JPA Criteria-based executor for filtered, sorted, projected, and paginated queries.

## [4.1.0] 2026/06/21

### Added

- Follow major spring version.

## [1.3.1] 2026/06/21

### Fixed

- Do maven publish after push tag on pull request merge.

## [1.3.0] 2026/06/21

### Added

- Align version with spring-boot with scripts.
...
- Integrated spring-query-swagger-processor DTO.
...
[1.3.0]: https://github.com/Zorin95670/spring-query-filter/blob/1.3.0/changelog.md
